; ModuleID = './cilkbench/2d-loop-pf.bc'
source_filename = "2d-loop.cpp"
...
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_2d_loop.cpp, i8* null }]
...
pfor.cond:                                        ; preds = %pfor.inc, %pfor.ph
  %indvar = phi i64 [ %indvar.next, %pfor.inc ], [ 0, %pfor.ph ]
...
for.body:                                         ; preds = %for.inc, %pfor.body
  %indvar1 = phi i64 [ %indvar.next2, %for.inc ], [ 0, %pfor.body ]
  %j.01 = phi i32 [ 0, %pfor.body ], [ %inc, %for.inc ]
  %0 = add i64 %indvar1, 5
  %scevgep = getelementptr [1000 x i32], [1000 x i32]* %array, i64 %indvar, i64 %0
  %scevgep3 = bitcast i32* %scevgep to i8*
  call void @llvm.prefetch.p0i8(i8* %scevgep3, i32 1, i32 1, i32 1)
...
for.body3:                                        ; preds = %for.inc, %for.body
  ...
  %0 = add i64 %indvar1, 5
  %scevgep = getelementptr [1000 x [1000 x i32]], [1000 x [1000 x i32]]* %array, i64 0, i64 %indvar, i64 %0
  %scevgep3 = bitcast i32* %scevgep to i8*
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_2d_loop.cpp() #0 section ".text.startup" {
entry:

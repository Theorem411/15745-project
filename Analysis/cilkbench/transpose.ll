...
@.str.1 = private unnamed_addr constant [24 x i8] c"Matrix Transpose Time: \00", align 1
@.str.2 = private unnamed_addr constant [10 x i8] c" seconds\0A\00", align 1
@llvm.global_ctors = appending global [1 x { i32, void ()*, i8* }] [{ i32, void ()*, i8* } { i32 65535, void ()* @_GLOBAL__sub_I_transpose.cpp, i8* null }]
...
define dso_local void @_Z15transposeMatrixPA1000_KiPA1000_i([1000 x i32]* noundef %inputMatrix, [1000 x i32]* noundef %outputMatrix) #4 {
entry:
...
pfor.cond:                                        ; preds = %pfor.inc, %pfor.ph
  %__begin.0 = phi i32 [ 0, %pfor.ph ], [ %inc10, %pfor.inc ]
...
for.body:                                         ; preds = %pfor.body, %for.inc
  ...
  %arrayidx5 = getelementptr inbounds [1000 x i32], [1000 x i32]* %inputMatrix, i64 %idxprom, i64 %idxprom4
  %0 = load i32, i32* %arrayidx5, align 4
  %idxprom6 = zext i32 %j.01 to i64
  %idxprom8 = zext i32 %__begin.0 to i64
  %arrayidx9 = getelementptr inbounds [1000 x i32], [1000 x i32]* %outputMatrix, i64 %idxprom6, i64 %idxprom8
...
pfor.inc:                                         ; preds = %pfor.preattach, %pfor.detach
  %inc10 = add nuw nsw i32 %__begin.0, 1
  %cmp11 = icmp ult i32 %__begin.0, 999
  br i1 %cmp11, label %pfor.cond, label %pfor.cond.cleanup, !llvm.loop !6
...
; Function Attrs: mustprogress noinline uwtable
define dso_local void @_Z11printMatrixPA1000_Ki([1000 x i32]* noundef %matrix) #4 {
entry:
  br label %for.body
...
for.body3:                                        ; preds = %for.body, %for.inc
  ...
  %idxprom4 = zext i32 %j.01 to i64
  %arrayidx5 = getelementptr inbounds [1000 x i32], [1000 x i32]* %matrix, i64 %idxprom, i64 %idxprom4
  %0 = load i32, i32* %arrayidx5, align 4
  ...
  %call6 = call noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) %call, i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str, i64 0, i64 0))
  br label %for.inc
...
for.end:                                          ; preds = %for.inc
  %call7 = call noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZNSolsEPFRSoS_E(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, %"class.std::basic_ostream"* (%"class.std::basic_ostream"*)* noundef nonnull @_ZSt4endlIcSt11char_traitsIcEERSt13basic_ostreamIT_T0_ES6_)
  br label %for.inc8

for.inc8:                                         ; preds = %for.end
  %inc9 = add nuw nsw i32 %i.02, 1
  %cmp = icmp ult i32 %i.02, 999
  br i1 %cmp, label %for.body, label %for.end10, !llvm.loop !9
...
entry:
  %inputMatrix = alloca [1000 x [1000 x i32]], align 16
  %outputMatrix = alloca [1000 x [1000 x i32]], align 16
...
for.body3:                                        ; preds = %for.body, %for.inc
  ...
  %idxprom = zext i32 %i.02 to i64
  %idxprom4 = zext i32 %j.01 to i64
  %arrayidx5 = getelementptr inbounds [1000 x [1000 x i32]], [1000 x [1000 x i32]]* %inputMatrix, i64 0, i64 %idxprom, i64 %idxprom4
...
for.end8:                                         ; preds = %for.inc6
  ...
  %arraydecay = getelementptr inbounds [1000 x [1000 x i32]], [1000 x [1000 x i32]]* %inputMatrix, i64 0, i64 0
  %arraydecay10 = getelementptr inbounds [1000 x [1000 x i32]], [1000 x [1000 x i32]]* %outputMatrix, i64 0, i64 0
  call void @_Z15transposeMatrixPA1000_KiPA1000_i([1000 x i32]* noundef nonnull %arraydecay, [1000 x i32]* noundef nonnull %arraydecay10)
  ...
  %call16 = call noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i8* noundef getelementptr inbounds ([24 x i8], [24 x i8]* @.str.1, i64 0, i64 0))
  ...
  %call19 = call noundef nonnull align 8 dereferenceable(8) %"class.std::basic_ostream"* @_ZStlsISt11char_traitsIcEERSt13basic_ostreamIcT_ES5_PKc(%"class.std::basic_ostream"* noundef nonnull align 8 dereferenceable(8) %call18, i8* noundef getelementptr inbounds ([10 x i8], [10 x i8]* @.str.2, i64 0, i64 0))
  ret i32 0
}
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_transpose.cpp() #0 section ".text.startup" {
entry:
